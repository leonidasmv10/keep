...
GLuint TextureManager::GetIdByName(const std::string& name) const
{
...
unsigned char* TextureManager::LoadTextureImage(const std::string& filepath, int& width, int& height, int& bpp,
                                                int format) const
{
